...
-- Création du type NOTAIRE_T
CREATE OR REPLACE TYPE NOTAIRE_T;
/

-- Création du type listRefNotaire_t
CREATE OR REPLACE TYPE listRefNotaire_t as table of REF NOTAIRE_T;
/

-- Création ou remplacement du type NOTAIRE_T
...
-- Création du type DOCUMENT_T
CREATE OR REPLACE TYPE DOCUMENT_T;
/

-- Création du type listRefDocuments_t
...
-- Création du type PAIEMENT_T
CREATE OR REPLACE TYPE PAIEMENT_T;
/

-- Création du type listRefPaiements_t
...
-- Création du type RENDEZVOUS_T
CREATE OR REPLACE TYPE RENDEZVOUS_T;
/

-- Création du type listRefRendevous_t
...
--============ Création de la table objet CLIENT_O ================================
...
--============ Création de la table objet NOTAIRE_O ================================
...
--============ Création de la table objet DOCUMENT_O ================================
...
--============ Création de la table objet PAIEMENT_O ================================
...
--============ Création de la table objet RENDEZVOUS_O ================================
...
--============ Création de la table objet DOSSIER_O ================================
